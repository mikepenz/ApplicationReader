...
public class DetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setNavigationOnClickListener(v -> DetailActivity.this.onBackPressed());
    ...
    View.OnClickListener fabClickListener = view -> UploadHelper.getInstance(DetailActivity.this, null).upload(appInfo);
    ...
    public void fillRow(View view, final String title, final String description) {
        ...
        view.setOnClickListener(v -> {
            ...
            Toast.makeText(DetailActivity.this, "Copied " + title, Toast.LENGTH_LONG).show();
        });
    }
